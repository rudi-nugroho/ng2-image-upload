...
var ImageUploadComponent = (function () {
    function ImageUploadComponent(imageService) {
        ...
        this.beforeUploadMaxSize = new core_1.EventEmitter();
    ...
    ImageUploadComponent.prototype.processUploadedFiles = function (existingFiles) {
                                ...
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        if (this_1.maxFileSize && file.size > this_1.maxFileSize) {
                                            ...
                                            this_1.fileTooLargeMessage = '';
                                            this_1.showFileTooLargeMessage = true;
                                            this_1.beforeUploadMaxSize.emit(file);
...
ImageUploadComponent.propDecorators = {
    ...
    'beforeUploadMaxSize': [{ type: core_1.Output },],
